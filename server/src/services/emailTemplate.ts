...
// Matches the design from BrandedEmailPreview.tsx
...
/**
 * Wraps plain-text email body in the branded OxyScale HTML template.
 * Converts newlines to <br />, inserts the signature block,
 * and matches the BrandedEmailPreview.tsx design.
 */
