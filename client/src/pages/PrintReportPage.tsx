...
function tierLabel(tier: string): string {
  return ({ new_lead: 'New lead', no_answer: 'Fairies', meeting_booked: 'Meeting booked',
    proposal: 'Proposal sent', pulse: 'Pulse', on_ice: 'Ice', won: 'Won', lost: 'Lost' })[tier] || tier;
}
          ...
          <div className="mb-3">
            ...
            <div className="grid grid-cols-4 gap-3 mb-6">
              {data.byTier
                ...
                .map((b) => {
                  const weight = ({ meeting_booked: '85%', proposal: '60%', pulse: '10%', new_lead: '5%' } as Record<string, string>)[b.tier];
                  return (
                  <div
                    key={b.tier}
                    ...
                    >
                      ...
                      <td className="py-2.5 pr-3 align-top">
                        <span className={`text-[11px] font-mono font-semibold uppercase tracking-[0.15em] ${
                          lead.tier === 'new_lead' ? 'text-[#0a9cd4]'
